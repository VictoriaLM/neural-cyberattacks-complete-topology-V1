...
public:
  ...
  */
  ...
  /**
   * Get which attack will be executed.
  */
  Dictionary get_type_attack_dict() const;

  /**
   * Get FLO attributes.
  */
  Dictionary get_FLO_dict() const;

  /**
   * Get JAM attributes.
  */
  Dictionary get_JAM_dict() const;

private:
  void call_update_(); //!< actually run simulation, aka wrap update_
  
  // Definition of the functions representing the behavior of each attack.
  void FLO_attack_();
  void JAM_attack_();
  ...
  // Global dictionaries to save the attributes of attacks
  Dictionary type_attack;
  Dictionary FLO_dict;
  Dictionary JAM_dict;
...
inline Dictionary
SimulationManager::get_type_attack_dict() const
{
  return type_attack;
}

inline Dictionary
SimulationManager::get_FLO_dict() const
{
  return FLO_dict;
}

inline Dictionary
SimulationManager::get_JAM_dict() const
{
  return JAM_dict;
}
